...
/*
 * Source: http://guideving.blogspot.fi/2010/08/sun-position-in-c.html
 */ 
...
namespace AR.Lighting
{
	...
	public class SunDirection : MonoBehaviour {
		...
		public static Vector2 getCurrentSunPosition() {
			return CalculateSunPosition(DateTime.Now,AR.Geolocation.LocationSourceManager.CurrentGeolocation.latitude, AR.Geolocation.LocationSourceManager.CurrentGeolocation.longitude);
		}

		public static Vector2 CalculateSunPosition(DateTime dateTime, double latitude, double longitude)  
		{  
			// Convert to UTC  
			...
			return new Vector2 ((float)(altitude * Rad2Deg), (float)(azimuth * Rad2Deg));
		}  
